...
export default {
  ...
  data() {
    return {
      ...
      errors: null,
      url: 'http://52.237.113.173/casecoolors/stock',
      img: 'http://52.237.113.173/casecoolors/getImages/',
      urlColor: 'http://52.237.113.173/casecoolors/colors',
      urlBrand: 'http://52.237.113.173/casecoolors/brand',
  ...
  methods:{
    ...
    async addNewCase(){
      try{
        ...
        const res = await fetch('http://52.237.113.173/casecoolors/stock/add',{
          method:'POST',
          body: formData
        })
    ...
    async deleteimg(image){
      const resimg = await fetch(`http://52.237.113.173/casecoolors/delImages/${image}`,{
          method: 'DELETE'
      })
    ...
    async deleteCase(id){
      try{
        const res = await fetch(`http://52.237.113.173/casecoolors/stock/${id}`,{
          method: 'DELETE'
        })
    ...
    async editCase(){
      try{
        ...
        if(this.image.includes(this.imageName)){
          ...
          const res = await fetch(`http://52.237.113.173/casecoolors/stock/edit/${this.editId}`,{
            method:'PUT',
            body: formDataEdit
          })
          ...
          const res = await fetch(`http://52.237.113.173/casecoolors/stock/add/${this.editId}`,{
            method:'PUT',
